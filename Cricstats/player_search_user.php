...
<body background="suru.jpg"><button style="background-color:#814111 "><a href="user1st.html" style="color: white">Back</a></button><br><br>


<?php
     $con = mysqli_connect("localhost", "root", "password", "cricket") or die(mysqli_error($con));
    ...
    if(mysqli_num_rows($res)>0){
    	...
    	echo " <h1><p align="."center".">".$row["playername"]."<p></h1><table width="."100%"." height="."400px"."><tr><th height="."100%"."></th><th><table width="."100%".">
